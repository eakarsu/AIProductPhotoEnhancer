...
// Custom Feature: Competitive visual intelligence
// Competitive visual intelligence: User uploads competitor product photos; AI analyzes presentation style (background, lighting, angles); recommends matching or differentiation strategies
import React, { useState } from 'react';

export default function CFCompetitiveVisualIntelligencePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-competitive-visual-intelligence/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Competitive visual intelligence</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Competitive visual intelligence: User uploads competitor product photos; AI analyzes presentation style (background, lighting, angles); recommends matching or differentiation strategies</p>
