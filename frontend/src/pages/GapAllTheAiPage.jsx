...
export default function GapAllTheAiPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-all-the-ai/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>All the AI</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>All the AI-themed route files exist as stubs — none expose actual AI endpoints in TSV</p>
