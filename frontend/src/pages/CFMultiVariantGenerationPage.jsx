...
// Custom Feature: Multi-variant generation
// Multi-variant generation: Single product photo; AI generates lifestyle variants (on model, in room, close-up); generates marketing copy per image
import React, { useState } from 'react';

export default function CFMultiVariantGenerationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-variant-generation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Multi-variant generation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Multi-variant generation: Single product photo; AI generates lifestyle variants (on model, in room, close-up); generates marketing copy per image</p>
