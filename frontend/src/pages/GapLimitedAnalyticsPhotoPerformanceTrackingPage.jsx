...
// Gap (Non-AI): Limited analytics (photo performance tracking)
// Limited analytics (photo performance tracking)
import React, { useState } from 'react';

export default function GapLimitedAnalyticsPhotoPerformanceTrackingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-analytics-photo-performance-tracking/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited analytics (photo performance tracking)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited analytics (photo performance tracking)</p>
