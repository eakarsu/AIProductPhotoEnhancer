...
export default function GapNoCompetitorPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-competitor/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/competitor</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /competitor-photo-style-detect (analyze competitor presentation)</p>
