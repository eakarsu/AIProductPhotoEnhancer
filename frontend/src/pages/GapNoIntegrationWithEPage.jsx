...
export default function GapNoIntegrationWithEPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-integration-with-e/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No integration with e</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No integration with e-commerce platforms (Shopify, WooCommerce) — grep 0 integration files</p>
