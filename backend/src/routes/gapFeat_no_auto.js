...
// Gap Feature: No \'/auto
// No /auto-compose-grid (auto-arrange product photos into grids)
...
async function callLLM(systemPrompt, userPrompt) {
  ...
  const res = await fetchFn('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'X-Title': 'AIProductPhotoEnhancer / gap-no-auto',
    },
    body: JSON.stringify({
